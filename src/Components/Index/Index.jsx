        ...
        <main className="main" >
          ...
          <li className="flex wrap li-index fondo-li p-30 flex-column-center">
            ...
            <li className="flex wrap li-index fondo-li-3 p-30 flex-column-center" >
              ...
              <h4 className="p-index">   Para clasificar la dificultad de los clips traté de guiarme por mi propia comprensión de los mismos, pero teniendo en cuenta también otros factores importantes.
              ...
              <h4 className="p-index"> Para que la actividad resulte efectiva se recomienda buscar clips de series/peliculas que puedan 
            ...
            <li className="flex wrap li-index fondo-li-4 p-30 flex-column-center" >
              ...
              <h4 className="p-index"> La opcion "Mostrar Respuesta" siempre esta disponible; Para realizar grabaciones, debera registrase. Una vez tenga un usuario 
