...
export const listaBojack = [
    ["Yeah great, get me away from the cameras?", "./src/audios/bojack/Grabacion1.m4a", "medium"], 
    ["...", "../src/audios/bojack/Grabacion2.m4a", "medium"],
    ["...", "../src/audios/bojack/Grabacion3.m4a", "medium"],
    ["...", "../src/audios/bojack/Grabacion4.m4a", "medium"],
    ["...?", "../src/audios/bojack/Grabacion5.m4a", "hard"],
    ["...", "../src/audios/bojack/Grabacion6.m4a", "easy"],
]

export const listaSimpsons = [
    [" Yeah give it a break doctor", "./src/audios/simpsons/Grabacion1.m4a"], 
